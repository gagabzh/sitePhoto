...
function renderTimelinePage({ groups, totalPhotos, uniqueUploaders, firstYear,
                               albums, tags, albumFilter, tagFilter,
                               fromFilter, toFilter, groupInterval, session }) {
...
module.exports = { renderTimelinePage };
