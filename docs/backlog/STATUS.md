...
| RF-8 | Standardize error response formats across all routes                 | Refactoring | Done | All 80+ error responses replaced with centralized error helpers |
| RF-9 | Create access control middleware (requireCanModify)                     | Refactoring | Done | Created middleware/access.js with requireCanModify, requireOwner, requireEntityExists factories |
